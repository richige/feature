...
#特徴量読み込み(1)
with open("/home/ubuntu/data/feature/team/features1.json", 'r') as f:
    f1_data = json.load(f)
...
#特徴量読み込み(2)
with open("/home/ubuntu/data/feature/team/features2.json", 'r') as f:
    f2_data = json.load(f)
...
#特徴量読み込み(3)
with open("/home/ubuntu/data/feature/team/features3.json", 'r') as f:
    f3_data = json.load(f)
...
#特徴量読み込み(4)
with open("/home/ubuntu/data/feature/team/features4.json", 'r') as f:
    f4_data = json.load(f)
...
#特徴量読み込み(5)
with open("/home/ubuntu/data/feature/team/features5.json", 'r') as f:
    f5_data = json.load(f)
...
#特徴量読み込み(6)
with open("/home/ubuntu/data/feature/team/features6.json", 'r') as f:
    f6_data = json.load(f)
...
file = open("/home/ubuntu/data/feature_n/team/features1.json", 'w')
...
file = open("/home/ubuntu/data/feature_n/team/features2.json", 'w')
...
for i in range(int(len(f3_data))):
    ...
    n3_data[str(frameNumber)]['l_dx']=f3_data[str(frameNumber)]['l_dx']
    n3_data[str(frameNumber)]['l_dy']=f3_data[str(frameNumber)]['l_dy']
    n3_data[str(frameNumber)]['r_dx']=f3_data[str(frameNumber)]['r_dx']
    n3_data[str(frameNumber)]['r_dy']=f3_data[str(frameNumber)]['r_dy']

file = open("/home/ubuntu/data/feature_n/team/features3.json", 'w')
...
for i in range(int(len(f4_data))):
    ...
    n4_data[str(frameNumber)]['l_dx']=f4_data[str(frameNumber)]['l_dx']
    n4_data[str(frameNumber)]['l_dy']=f4_data[str(frameNumber)]['l_dy']
    n4_data[str(frameNumber)]['r_dx']=f4_data[str(frameNumber)]['r_dx']
    n4_data[str(frameNumber)]['r_dy']=f4_data[str(frameNumber)]['r_dy']

file = open("/home/ubuntu/data/feature_n/team/features4.json", 'w')
...
for i in range(int(len(f5_data))):
    ...
    n5_data[str(frameNumber)]['l_dx']=f5_data[str(frameNumber)]['l_dx']
    n5_data[str(frameNumber)]['l_dy']=f5_data[str(frameNumber)]['l_dy']
    n5_data[str(frameNumber)]['r_dx']=f5_data[str(frameNumber)]['r_dx']
    n5_data[str(frameNumber)]['r_dy']=f5_data[str(frameNumber)]['r_dy']


file = open("/home/ubuntu/data/feature_n/team/features5.json", 'w')
...
for i in range(int(len(f6_data))):
    ...
    n6_data[str(frameNumber)]['l_dx']=f6_data[str(frameNumber)]['l_dx']
    n6_data[str(frameNumber)]['l_dy']=f6_data[str(frameNumber)]['l_dy']
    n6_data[str(frameNumber)]['r_dx']=f6_data[str(frameNumber)]['r_dx']
    n6_data[str(frameNumber)]['r_dy']=f6_data[str(frameNumber)]['r_dy']

file = open("/home/ubuntu/data/feature_n/team/features6.json", 'w')
